...
**Example usage:**
```typescript
import { allBypassMethods } from 'zeroleaks/knowledge';
...
**Example:**
```typescript
import { getBypassMethodsForDefense } from 'zeroleaks/knowledge';
...
**Example:**
```typescript
import { getDocumentedBypassMethods } from 'zeroleaks/knowledge';
...
**Example:**
```typescript
import { getHighSuccessBypassMethods } from 'zeroleaks/knowledge';
...
**Example usage:**
```typescript
import { defenseEffectivenessMatrix } from 'zeroleaks/knowledge';
